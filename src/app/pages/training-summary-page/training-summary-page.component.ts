...
@Component({
  selector: 'app-training-summary-page',
  templateUrl: './training-summary-page.component.html',
  styleUrls: ['./training-summary-page.component.css']
})
export class TrainingSummaryPageComponent implements OnInit, AfterViewInit {
  ...
  onTrainClick = () => {
    this.router.navigate(['/training-test']);
  }
